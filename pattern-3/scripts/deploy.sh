...
# create the APIM Key Manager ConfigMaps
...
# create the APIM Publisher ConfigMaps
${KUBECTL} create configmap apim-publisher-conf --from-file=../confs/apim-publisher/repository/conf/
${KUBECTL} create configmap apim-publisher-conf-datasources --from-file=../confs/apim-publisher/repository/conf/datasources/

# create the APIM Store ConfigMaps
${KUBECTL} create configmap apim-store-conf --from-file=../confs/apim-store/repository/conf/
${KUBECTL} create configmap apim-store-conf-datasources --from-file=../confs/apim-store/repository/conf/datasources/

# create the APIM Traffic Manager ConfigMaps
${KUBECTL} create configmap apim-tm-bin --from-file=../confs/apim-tm/bin/
${KUBECTL} create configmap apim-tm-conf --from-file=../confs/apim-tm/repository/conf/

# create the APIM Gateway ConfigMaps
${KUBECTL} create configmap apim-gateway-conf --from-file=../confs/apim-gateway/repository/conf/
${KUBECTL} create configmap apim-gateway-conf-axis2 --from-file=../confs/apim-gateway/repository/conf/axis2/
